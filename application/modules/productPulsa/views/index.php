		...
		<div class="col-md-6">	
			...
			<div class="card text-white bg-dark bot-pad" >
			  	<div class="card-body">
			    	...
			    	<p class="card-text"></p>
			    	<p></p>
			    	<button class="btn btn-primary addChart detail pull-right" data-id="<?= $id ?>" data-idOperator="<?= $value->id ?>">Detail</button>
			  	</div>
			</div>

			<div class="container" id="tabData<?= $id ?>" style=" display: none;" >

				<ul class="nav nav-tabs" role="tablist">
				  	<li class="nav-item">
				    	<a class="nav-link active" href="#pulsa<?= $id ?>" role="tab" data-toggle="tab">Pulsa</a>
				  	</li>
				  	<li class="nav-item">
				    	<a class="nav-link" href="#paketData<?= $id ?>" role="tab" data-toggle="tab">Paket Data</a>
				  	</li>
				...
				<div class="tab-content  bg-dark">
					<br>
				  	<div role="tabpanel" class="tab-pane fade show  active" id="pulsa<?= $id ?>"></div>
				  	<div role="tabpanel" class="tab-pane fade" id="paketData<?= $id ?>">bbb</div>
				</div>				
