...
<div class="col-md-6 col-md-offset-3">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('fare/fare_passanger/action_edit', 'id="ff" autocomplete="on"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <select class="form-control select2" required name="type" id="type">
                                ...
                                <?php foreach($type as $key=>$value ) { ?>
                                    <option value="<?php echo $this->enc->encode($value->id) ?>" <?php echo $value->id==$detail->passanger_type?"selected":""; ?>><?php echo strtoupper($value->name); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" name="insurance_fee" id="insurance_fee" onkeypress="return isNumberKey(event)"  placeholder="Asuransi Jasa Raharja" value="<?php echo $detail->insurance_fee ?>">
                        </div>
