...
<div class="col-md-6 col-md-offset-3">
    <div class="portlet box blue" id="box">
        ...
        <div class="portlet-body">
            <?php echo form_open('fare/fare_vehicle/action_add', 'id="ff" autocomplete="off"'); ?>
            <div class="box-body">
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" name="entry_fee" id="entry_fee"  placeholder="Tarif Masuk"  onkeypress="return isNumberKey(event)">
                        </div>   
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" name="dock_fee" id="dock_fee"   placeholder="Jasa Deramaga"  onkeypress="return isNumberKey(event) ">
                        </div>   

                        <div class="col-sm-6 form-group">
                            <label>Ifpro</label>
                            <input type="text" class="form-control" name="ifpro" onkeypress="return isNumberKey(event)"  placeholder="Ifpro" id="ifpro">
                        </div>   
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" name="trip_fee" onkeypress="return isNumberKey(event)"  placeholder="Tarif Jasa" id="trip_fee">
                        </div>   

                        <div class="col-sm-6 form-group">
                            <label>Biaya Bertanggung Jawab</label>
                            <input type="text" class="form-control" name="responsibility_fee" onkeypress="return isNumberKey(event)"  placeholder="Biaya Bertanggung Jawab" id="responsibility_fee">
                        </div>   
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#entry_fee").on("keyup",function(){
            getData()
        });

        $("#dock_fee").on("keyup",function(){
            getData()
        });

        $("#ifpro").on("keyup",function(){
            getData()
        });

        $("#trip_fee").on("keyup",function(){
            getData()
        });

        $("#responsibility_fee").on("keyup",function(){
            getData()
        });
