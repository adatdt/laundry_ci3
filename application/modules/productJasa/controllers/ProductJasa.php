...
class ProductJasa extends MY_Controller{
	public function __construct(){
		parent::__construct();

        $this->load->model('productJasaModel','product');
	}
	...
	public function index($kategori=""){   
        ...
        $data = array(
            'title'    => 'Product',
            'content'  => 'index',
            'category' => $this->product->select_data("product_service", " where status=1 ")->result()
        );
