...
<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-lg modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url()?>service/actionAdd" method="post" id="formData">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-sm-3 col-form-label">Nama Layanan<span style="color: red">*</span> </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" readonly value=1 min=0 class="form-control" id="unitWeight" placeholder="Berat" name="unitWeight"  required onkeypress="return isNumberKey(event)"> 
                            </div>
                        </div>
